...
filteraverageT6 <- subset(averageT6_figure1B, (grepl('Pauljensenia sp900541895|Veillonella sp018367495|Rothia sp902373285|Streptococcus sp000187445', species)))
...
ggplot(species_abundance5,aes(reorder(species,mean_abundance),mean_abundance, fill=genus))+
  ...
  facet_wrap(~Measurement_point*sample_type,scales='free_x', ncol=5)+
  coord_flip()+
